...
# Github: https://github.com/Makavael/pycenter/
# License: https://github.com/billyMakavael/pycenter/blob/main/LICENSE
...
class Netflixer:
    ...
    def ui(self):
        os.system("cls && title [NETFLIXER] - Made by Ahmed Samir Makavael")
        text = """
